...
import ru.photorex.hw13.acl.service.MongoMutableAclService;
...
public class AclConfig {
    ...
    public LookupStrategy lookupStrategy() {
        return new MongoBasicLookupStrategy(aclAuthorizationStrategy(), aclCache(), permissionGrantingStrategy(), mongoTemplate);
    }

    @Bean
    public MongoMutableAclService aclService() {
        return new MongoMutableAclService(aclRepository, lookupStrategy(), aclCache());
    }
}
